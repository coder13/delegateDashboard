...
describe('import helpers', () => {
  ...
  it('throws when no stage is provided with multiple rooms', () => {
    ...
    expect(() =>
      findCompetingAssignment(wcif.schedule.venues[0].rooms, { email: 'alice', '333': '1' }, wcif.persons[0], '333')
  ...
  it('reports missing group activities and fills stage information', () => {
    ...
    const assignments: ParsedAssignment[] = [
      { registrantId: 1, eventId: '333', groupNumber: 2, activityCode: '333-r1-g2', assignmentCode: 'competitor', roomId: 10 },
      { registrantId: 1, eventId: '333', groupNumber: 2, activityCode: '333-r1-g2', assignmentCode: 'staff-judge' },
    ];
  ...
  it('creates and balances missing group activities', () => {
    ...
    const [firstGroup, secondGroup] = balanced.schedule.venues[0].rooms[0].activities[0].childActivities;
  ...
  it('upserts competitor assignments without duplication', () => {
    ...
    const updated = upsertCompetitorAssignments(wcif, [
      { registrantId: 1, eventId: '333', groupNumber: 1, activityCode: '333-r1-g1', assignmentCode: 'competitor', roomId: 10 },
      { registrantId: 1, eventId: '333', groupNumber: 1, activityCode: '333-r1-g1', assignmentCode: 'competitor', roomId: 10 },
    ]);
