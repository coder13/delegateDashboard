...
describe('time formatting helpers', () => {
  ...
  it('formats time using navigator languages and options', () => {
    ...
    expect(spy).toHaveBeenCalledWith(['en-US'], expect.objectContaining({ hour: '2-digit', minute: '2-digit' }));
  });
  ...
  it('formats a time range using formatted outputs', () => {
    ...
    expect(formatTimeRange('2024-01-01T10:00:00Z', '2024-01-01T11:00:00Z')).toBe('10:00 AM - 11:00 AM');
  ...
  it('formats a date time range on the same day', () => {
    ...
    expect(
      formatDateTimeRange('2024-01-01T10:00:00Z', '2024-01-01T11:00:00Z')
    ).toBe('Jan 1, 2024 10:00 AM - 11:00 AM');
  });
  ...
  it('formats a date time range across days', () => {
    ...
    expect(
      formatDateTimeRange('2024-01-01T10:00:00Z', '2024-01-02T11:00:00Z')
